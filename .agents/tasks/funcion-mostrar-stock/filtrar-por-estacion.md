...
- [ ] La función agrupa correctamente los productos por estación
- [ ] La función devuelve exclusivamente la información pedida en la descripción
- [ ] La función maneja apropiadamente las excepciones, informando del error, sin terminar abruptamente la ejecución del programa.
...
- Los erroes de la api deben tratarse apropiadamente, la webapp no puede dejar de funciona